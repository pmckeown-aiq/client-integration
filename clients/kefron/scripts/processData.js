      ...
      workbook.xlsx.readFile(templateFile)
        .then(function() {
          ...
          consolidatedInvoice.lines.forEach(function(line) {
            ...
            worksheet.addRow([line.ExternalReference, consolidatedInvoice.SummarySubAccount, line.StockItemDescriptionType3, line.WorkOrder, line.WorkOrderDate, line.InvoicedQuantity, line.StockItemPrice, line.NetAmount, line.TaxAmount, line.NetAmount + line.TaxAmount ]);
          });
          // Add totals 
          var rowValues = [];
...
function createConsolidatedInvoices(customer, invoiceLines, opts) {
  return new Promise(function(resolve, reject){
    ...
    consolidatedInvoice.SummarySubAccount = myInvoices[0].SummarySubAccount;
...
function summariseConsolidatedInvoice(consolidatedInvoice, opts) {
  return new Promise(function(resolve, reject){
        ...
        var props = ['SummarySubAccount', 'GLAccountCode', 'TaxCode' ,'StockItemID', 'ActualPrice', 'StockItemPrice', 'DepartmentID'];
